...
def test_match_by_reference_assigns_to_existing_case():
    async def run():
        ...
        result = await integrate_document_analysis(
            ...
            reference_values=[('invoice_number', 'INV-2025-001')],
...
def test_draft_case_stores_reference():
    async def run():
        ...
        result = await integrate_document_analysis(
            ...
            document_date=None,
            due_date=None,
            reference_values=[('invoice_number', 'INV-REF-999')],
            filename=None,
...
def test_reminder_creates_dunning_case():
    async def run():
        ...
        result = await integrate_document_analysis(
            ...
            reference_values=[('invoice_number', 'MAH-2025-001')],
            filename=None,
...
def test_cross_tenant_isolation():
    async def run():
        ...
        result = await integrate_document_analysis(
            ...
            document_date=None,
            due_date=None,
            reference_values=[('invoice_number', 'INV-SHARED')],
            filename=None,
