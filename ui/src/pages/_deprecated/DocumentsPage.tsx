      ...
      <div className="flex-1 overflow-y-auto px-4 py-2">
        {loading && (
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 animate-pulse">
            {[0, 1, 2, 3, 4, 5].map((i) => (
              <div key={i} style={{ borderRadius: '14px', overflow: 'hidden', backgroundColor: 'var(--frya-surface-container)' }}>
                <div style={{ width: '100%', aspectRatio: '3/4', backgroundColor: 'var(--frya-outline-variant)', opacity: 0.4 }} />
                <div style={{ padding: '8px 12px 10px' }}>
                  <div style={{ height: '12px', width: '80%', borderRadius: '4px', backgroundColor: 'var(--frya-outline-variant)', marginBottom: '6px' }} />
                  <div style={{ height: '10px', width: '50%', borderRadius: '4px', backgroundColor: 'var(--frya-outline-variant)', opacity: 0.6 }} />
                </div>
              </div>
            ))}
          </div>
