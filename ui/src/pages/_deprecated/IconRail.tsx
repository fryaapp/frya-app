...
export function IconRail({ className = '' }: IconRailProps) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="w-8 h-8 rounded-full overflow-hidden mb-4 flex-shrink-0" style={{ boxShadow: '0 2px 8px rgba(240,138,58,0.3)' }}>
        <img src="/frya-avatar.png" alt="FRYA" className="w-full h-full object-cover" />
      </div>
